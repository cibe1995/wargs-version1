...
public class VRTouchThrowTeleporter : MonoBehaviour {
    ...
    void LeftThrower()
    {
        VRTouchMove2.InputData InputHolderDown = refSystem.InputReturnDown(TeleportButton);
        VRTouchMove2.InputData InputHolderUp = refSystem.InputReturnUp(TeleportButton);
